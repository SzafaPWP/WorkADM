...
class EmployeeDialog(tk.Toplevel):
    ...
    def create_widgets(self):
        ...
        ttk.Label(frame, text="Zmiana:").grid(row=5, column=0, padx=6, pady=4, sticky="w")
        self.shift_var = tk.StringVar()
        self.shift_combo = ttk.Combobox(frame, textvariable=self.shift_var, values=['A','B','C','D'], state='readonly', width=22)
        self.shift_combo.grid(row=5, column=1, padx=6, pady=4, sticky="w")
                                        state="readonly")
